...
/* ALGROITHM TO RUN */
#define FLOCKING true        // TODO: SET TO TRUE IF TEST FLOCKING ALGORITHM
#define FORMATION false // TODO: SET TO TRUE IF TEST FORMATION ALGORITHM
...
#define FLOCK_NUMBER 1         // TODO: SET THE FLOCK NUMBER THE SAME FOR ALL ROBOTS THAT ARE IN THE SAME FLOCK
#define WORLD 1                // TODO: SET WORLD TO {0: OBSTACLES, 1: CROSSING, else: OWN INIT}

// TODO: DECIDE THE LAPLACIAN FORMATION AND THE MIGRATORY urge                          
double initial_formation[2][FLOCK_SIZE] = {{0,0,0,-0.2,0.2},{0.2,-0.2,0,0,0}};            // DESIRED FORMATION !!!
...
#define K_migration_laplacian       0.20    // Migration urge for the formation controller

#define K_laplacian                 1.05    //1.5  // weight of the Laplacian with respect to migratory urge 
