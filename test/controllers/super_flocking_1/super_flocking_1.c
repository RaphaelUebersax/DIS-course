...
#define FLOCK_SIZE	5		                         // Number of robots in flock (DOES NOT WORK WITH MORE THAN 5!!!)

//int offset = 0;      // Offset number to consider from roffset to offset+FLOCK_SIZE: for epuck0-4
int offset = FLOCK_SIZE;      // for epuck5-9

int simulation_time = 30000;  // Duration of simulation for metric computation
